...
└─$ nmap -sn 10.6.6.0/24
```
![Screenshot of host discovery output](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_host_discovery_output.png)
...
```
![Screenshot of OS detection results](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_OS_detection_results.png)
...
```
![Screenshot of aggressive scan on port 21](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_aggressive_scan_on_port_21.png)
...
```
![Screenshot of SMB port scan](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_SMB_port_scan.png)
...
```
![Screenshot of script output](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_script_output.png)
...
![Screenshot of smbclient connection](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_smbclient_connection.png)
...
└─$ cat /etc/resolv.conf
```
![Screenshot of network config commands](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_network_config_commands.png)
...
└─$ ls ladies.pcap
```
![Screenshot of tcpdump running and file listing](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_tcpdump_running_and_file_listing.png)
...
└─$ wireshark
```
![Screenshot of Wireshark opening the pcap file](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_Wireshark_opening_the_pcap_file.png)
...
└─# scapy
```
![Screenshot of Scapy startup](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_Scapy_startup.png)
...
>>> paro.summary()
```
![Screenshot of paro.summary() output](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_paro.summary()_output.png)
...
>>> paro2.summary()
```
![Screenshot of paro2 summary](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_paro2_summary.png)
...
>>> paro3.summary()
```
![Screenshot of paro3 summary showing 5 ICMP packets](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_paro3_summary_showing_5_ICMP_packets.png)
...
>>> paro3[3]
```
![Screenshot of specific packet details](NMAP_and_Scapy_Lab/screenshots/Screenshot_of_specific_packet_details.png)
